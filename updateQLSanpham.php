...
if (isset($_GET["id"])) {
    ...
    $sql = "UPDATE sanpham
            ...
            if (mysqli_query($conn, $sql)) {
                echo "<div class='list'>Cập nhật sản phẩm thành công. <a href='indexQLSanpham.php'>Quay lại</a></div>";
                exit;
            } else {
...
<div class="list">
<?php
echo '<form action="indexQLSanpham.php?mod=update&id='.$id.'" method="POST" >';
?>
    <table>
        <tr>
            <td>
                ...
                <p>Giá hàng </p>
                <?php
                echo'<p><input id="GiaHang" type="number" size="50" name="GiaHang" value="'.$row['GiaHang'].'" /></p>';
                ?>
                </td></tr><tr><td>
                <p>Ngày nhập hàng </p>
                <?php
