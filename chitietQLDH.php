...
if(isset($_GET['id'])) {
    ...
    echo '</div><div class="list">';
    echo '<a class="submit" href="indexQLDH.php?mod=giaohang&id='.$row['MaDonDatHang'].'">Giao hàng</a>';
    echo ' <a class="submit" href="indexQLDH.php?mod=danggiao&id='.$row['MaDonDatHang'].'">Đang giao hàng</a>';
    echo ' <a class="submit" href="indexQLDH.php?mod=chuagiaohang&id='.$row['MaDonDatHang'].'">Chưa giao hàng</a>';
    echo ' <a class="submit1" href="indexQLDH.php?mod=thanhtoan&id='.$row['MaDonDatHang'].'">Thanh toán</a>';
    echo ' <a class="submit1" href="indexQLDH.php?mod=chuathanhtoan&id='.$row['MaDonDatHang'].'">Chưa thanh toán</a>';
    echo ' <a class="submit2" href="indexQLDH.php?mod=huy&id='.$row['MaDonDatHang'].'">Hủy đơn hàng</a>';
    echo ' <a class="submit3" href="indexQLDH.php?mod=in&id='.$row['MaDonDatHang'].'">In hóa đơn</a>';
    echo '</div><div class="list">';
    echo 'Các sản phẩm: ';
    $stt = 1;
